...
Public Module GameLibraryModule
   ...
   Private ReadOnly FILE_TYPES() As String = {"Electronic Arts", "Mythos Software"}                                                                                 'The descriptions for the supported library file types.
   ...
   'This procedure extracts the specified library's files.
